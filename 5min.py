...
def run_strategy():
    ...
    for symbol in symbols:
        ...
        try:
            ...
            #Tendencia:        
            if dfr['low_accumulation'][-2] == True and dfr['order_block'][-2] == True and 50 < df['rsi'][-2] < 40:
                if df['sl_long'][-2] == 1:
            ...
            if dfr['low_accumulation'][-2] == True and dfr['order_block'][-2] == True and 60 < df['rsi'][-2] < 50:
                if df['sl_short'][-2] == 1:  
